...
export function ensureControl(state) {
  ...
  const defaults = Object.fromEntries(AUTOMATION_DEFINITIONS.map(rule => [rule.id, {
    permitted: true, risk: 'low', intervalMinutes: rule.id === 'dailyOpsBrief' ? 1440 : rule.id === 'channelSync' ? 30 : rule.id === 'marketingPlanner' ? 1440 : rule.id === 'marketingCreativeWorker' ? 15 : rule.id === 'marketRadar' ? 1440 : 15,
    maxRunsPerDay: rule.id === 'dailyOpsBrief' ? 3 : rule.id === 'channelSync' ? 48 : rule.id === 'marketingPlanner' ? 2 : rule.id === 'marketingCreativeWorker' ? 32 : rule.id === 'marketRadar' ? 4 : 96, spendLimit: 0
  }]));
